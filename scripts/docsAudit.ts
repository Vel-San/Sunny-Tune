...
const OFFICIAL_DOCS: ReadonlyArray<{
  ...
  // ── Models ────────────────────────────────────────────────────────────
  {
    id: "AdjustCameraOffset",
    label: "Adjust Camera Offset",
    section: "Models",
    docsPath: "settings/models/",
  },
  {
    id: "AdjustLaneTurnSpeed",
    label: "Adjust Lane Turn Speed",
    section: "Models",
    docsPath: "settings/models/",
    note: "requires LaneTurnDesire + ShowAdvancedControls",
  },
  {
    id: "ManualSoftwareDelay",
    label: "Adjust Software Delay",
    section: "Models",
    docsPath: "settings/models/",
    note: "requires ShowAdvancedControls; only when LAGD disabled",
  },
  {
    id: "DrivingModel",
    label: "Driving Model",
  ...
  {
    id: "LiveLearningSteerDelay",
    label: "Live Learning Steer Delay (LAGD)",
    section: "Models",
    docsPath: "settings/models/",
  },
  ...
  },
  {
    ...
    label: "Disengage on Accelerator Pedal",
    section: "Toggles",
    docsPath: "settings/toggles/",
  },
  {
    id: "DrivingPersonality",
    label: "Driving Personality",
    section: "Toggles",
    docsPath: "settings/toggles/",
  },
  {
    id: "LaneDepartureWarnings",
    label: "Enable Lane Departure Warnings",
    section: "Toggles",
    docsPath: "settings/toggles/",
  },
  {
    id: "AlwaysOnDriverMonitor",
  ...
  {
    id: "RecordFrontLock",
    label: "Record Driver Camera",
    section: "Toggles",
    docsPath: "settings/toggles/",
  },
  {
    id: "RecordUploadMicAudio",
    label: "Record Mic Audio",
    section: "Toggles",
    docsPath: "settings/toggles/",
  },
  {
  ...
  // ── Steering — main ──────────────────────────────────────────────────
  {
    ...
    label: "MADS Enabled",
    section: "Steering",
    docsPath: "settings/steering/",
  },
  {
    id: "EnforceTorqueControl",
    label: "Enforce Torque Lateral Control",
    section: "Steering",
    docsPath: "settings/steering/",
  },
  {
    id: "NeuralNetworkLateralControl",
  ...
  {
    id: "BlinkerPauseLateralControl",
    label: "Pause Lateral Control with Blinker",
    section: "Steering",
    docsPath: "settings/steering/",
  },
  {
    id: "BlinkerMinLateralControlSpeed",
    label: "Minimum Speed to Pause Lateral Control",
    section: "Steering",
    docsPath: "settings/steering/",
    note: "sub-setting of Pause Lateral",
  },
  {
    id: "BlinkerLateralReengageDelay",
    label: "Post-Blinker Delay",
    section: "Steering",
    docsPath: "settings/steering/",
    note: "0–10 s after blinker off",
  },

  // ── Steering — MADS ──────────────────────────────────────────────────
  {
    id: "MadsMainCruiseAllowed",
    label: "Toggle MADS with Main Cruise",
    section: "Steering — MADS",
    docsPath: "settings/steering/mads/",
  },
  {
    id: "MadsUnifiedEngagementMode",
    label: "Unified Engagement Mode (UEM)",
    section: "Steering — MADS",
    docsPath: "settings/steering/mads/",
  },
  {
    id: "MadsSteeringMode",
    label: "Steering Mode on Brake Pedal",
    section: "Steering — MADS",
    docsPath: "settings/steering/mads/",
    note: "0=Remain Active, 1=Pause, 2=Disengage",
  },

  // ── Steering — Lane Change ────────────────────────────────────────────
  {
    id: "AutoLaneChangeTimer",
    label: "Auto Lane Change by Blinker",
    section: "Steering — Lane Change",
    docsPath: "settings/steering/lane-change/",
    note: "Off=-1, Nudge=0, Nudgeless=1, 0.5s=2, 1s=3, 2s=4, 3s=5",
  },
  {
    id: "AutoLaneChangeBsmDelay",
  ...
  // ── Steering — Torque ─────────────────────────────────────────────────
  {
    id: "TorqueControlTuneVersion",
    label: "Torque Control Tune Version",
    section: "Steering — Torque",
    docsPath: "settings/steering/torque/",
  },
  {
    id: "SelfTune",
    label: "Self-Tune (Live Torque Params)",
    section: "Steering — Torque",
    docsPath: "settings/steering/torque/",
  },
  {
    id: "LessRestrictSettingsForSelfTune",
    label: "Less Restrict Settings for Self-Tune",
    section: "Steering — Torque",
    docsPath: "settings/steering/torque/",
    note: "requires SelfTune",
  },
  {
    id: "EnableCustomTorqueTuning",
    label: "Enable Custom Torque Tuning",
    section: "Steering — Torque",
    docsPath: "settings/steering/torque/",
  },
  {
    id: "ManualTuneFriction",
    label: "Manual Tune — Friction",
    section: "Steering — Torque",
    docsPath: "settings/steering/torque/",
    note: "requires EnableCustomTorqueTuning",
  },
  {
    id: "TorqueParamsOverrideLatAccelFactor",
    label: "Manual Tune — Lat Accel Factor",
    section: "Steering — Torque",
    docsPath: "settings/steering/torque/",
    note: "requires EnableCustomTorqueTuning",
  },
  ...
  // ── Cruise ────────────────────────────────────────────────────────────
  {
    id: "IntelligentCruiseButtonManagement",
    label: "Intelligent Cruise Button Management (ICBM)",
    section: "Cruise",
    docsPath: "settings/cruise/",
    note: "Alpha feature",
  },
  {
    id: "VisionBasedTurnSpeedControl",
    label: "Smart Cruise Control — Vision (SCC-V)",
    section: "Cruise",
    docsPath: "settings/cruise/",
  },
  {
    id: "SmartCruiseControlMap",
    label: "Smart Cruise Control — Map (SCC-M)",
    section: "Cruise",
    docsPath: "settings/cruise/",
  },
  {
    id: "CustomAccIncrementsEnabled",
    label: "Custom ACC Speed Increments",
    section: "Cruise",
    docsPath: "settings/cruise/",
  },
  {
    id: "CustomAccShortPressIncrement",
    label: "Custom ACC Short Press Increment",
    section: "Cruise",
    docsPath: "settings/cruise/",
    note: "requires CustomAccIncrementsEnabled",
  },
  {
    id: "CustomAccLongPressIncrement",
    label: "Custom ACC Long Press Increment",
    section: "Cruise",
    docsPath: "settings/cruise/",
    note: "requires CustomAccIncrementsEnabled",
  },
  {
    id: "DynamicExperimentalControl",
    label: "Enable Dynamic Experimental Control",
    section: "Cruise",
    docsPath: "settings/cruise/",
  },
  ...
  // ── Cruise — Speed Limit ──────────────────────────────────────────────
  {
    ...
    section: "Cruise — Speed Limit",
    docsPath: "settings/cruise/speed-limit/",
    note: "Off=0, Info=1, Warning=2, Assist=3",
  },
  {
    id: "SpeedLimitSource",
    label: "Speed Limit Source",
    section: "Cruise — Speed Limit",
    docsPath: "settings/cruise/speed-limit/source/",
    note: "Car=0, Map=1, CarPriority=2, MapPriority=3, Combined=4",
  },
  {
    id: "SpeedLimitOffsetType",
    label: "Speed Limit Offset Type",
    section: "Cruise — Speed Limit",
    docsPath: "settings/cruise/speed-limit/",
    note: "none / fixed / percentage",
  },
  {
    id: "SpeedLimitValueOffset",
    label: "Speed Limit Value Offset",
    section: "Cruise — Speed Limit",
    docsPath: "settings/cruise/speed-limit/",
    note: "-30 to +30",
  },
  ...
  {
    id: "RainbowMode",
    label: "Enable Tesla Rainbow Mode",
    section: "Visuals",
    docsPath: "settings/visuals/",
    note: "cosmetic only",
  },
  ...
  {
    id: "GreenLightAlert",
    label: "Green Traffic Light Alert (Beta)",
    section: "Visuals",
    docsPath: "settings/visuals/",
  },
  {
    id: "LeadDepartAlert",
    label: "Lead Departure Alert (Beta)",
    section: "Visuals",
    docsPath: "settings/visuals/",
  },
  {
  ...
  {
    id: "ShowTurnSignals",
    label: "Display Turn Signals",
    section: "Visuals",
    docsPath: "settings/visuals/",
  },
  {
    id: "DisplayRocketFuelBar",
    label: "Real-time Acceleration Bar",
    section: "Visuals",
    docsPath: "settings/visuals/",
  },
  {
    id: "ChevronInfo",
    label: "Display Metrics Below Chevron",
    section: "Visuals",
    docsPath: "settings/visuals/",
  },
  {
  ...
  // ── Developer ─────────────────────────────────────────────────────────
  {
    id: "AlphaLongitudinalEnabled",
    label: "Alpha Longitudinal Control",
    section: "Developer",
    docsPath: "features/cruise/alpha-longitudinal/",
    note: "disables AEB; mutually exclusive with ICBM",
  },
  {
  ...
  {
    id: "QuickBoot",
    label: "Quickboot Mode",
    section: "Developer",
    docsPath: "settings/developer/",
    note: "requires DisableUpdates",
  },

  // ── Network ───────────────────────────────────────────────────────────
  {
    id: "GsmMetered",
    label: "GSM Metered (upload on Wi-Fi only)",
    section: "Network",
    docsPath: "settings/network/",
  },
  {
    id: "GsmApn",
    label: "GSM APN",
  ...
  // ── Device ────────────────────────────────────────────────────────────
  {
    ...
    label: "Use Metric System",
    section: "Device",
    docsPath: "settings/device/",
  },
  {
    id: "RecordUploadDriverCamera",
    label: "Record & Upload Driver Camera",
    section: "Device",
    docsPath: "settings/device/",
  },
  {
  ...
  },
  {
    ...
    section: "Software",
    docsPath: "settings/software/",
    note: "locks version, no auto-updates",
  },

  // ── SunnyLink ─────────────────────────────────────────────────────────
  {
    id: "SunnylinkEnabled",
    label: "SunnyLink Connectivity",
    section: "SunnyLink",
    docsPath: "settings/sunnylink/",
  },

  // ── OSM ───────────────────────────────────────────────────────────────
  {
    id: "OsmLocal",
    label: "OSM Local Maps",
    section: "OSM",
    docsPath: "settings/osm/",
  },
  {
    id: "MapAdvisorySpeedLimit",
  ...
  // ── Vehicle-specific ──────────────────────────────────────────────────
  {
    id: "HyundaiLongitudinalTuning",
    label: "Hyundai Longitudinal Tuning",
    section: "Vehicle",
    docsPath: "settings/vehicle/",
    note: "Hyundai/Kia/Genesis only",
  },
  {
    id: "TeslaCoopSteering",
  ...
  {
    id: "ToyotaEnforceFactoryLongitudinalControl",
    label: "Toyota: Enforce Factory Longitudinal Control",
    section: "Vehicle",
    docsPath: "settings/vehicle/",
    note: "Toyota only",
  },
...
const OUR_SPKEYS: ReadonlyArray<{
  spKey: string;
  section: string;
  field: string;
}> = [
  ...
  { spKey: "LiveTorqueParamsToggle", section: "lateral", field: "liveTorque" },
  {
    ...
    section: "lateral",
    field: "liveTorqueRelaxed",
  },
  {
    spKey: "TorqueControlTune",
    section: "lateral",
    field: "torqueControlTune",
  },
  ...
  },
  {
    ...
    section: "lateral",
    field: "torqueOverride.enabled",
  },
  {
    spKey: "ManualTuneFriction",
    section: "lateral",
    field: "torqueOverride.friction",
  },
  {
    spKey: "TorqueParamsOverrideLatAccelFactor",
    section: "lateral",
    field: "torqueOverride.latAccelFactor",
  },
  // Longitudinal
  ...
  // Speed Control
  {
    ...
    field: "speedLimitControl.mode",
  },
  {
    spKey: "SpeedLimitSource",
    section: "speedControl",
    field: "speedLimitControl.policy",
  },
  {
    spKey: "SpeedLimitOffsetType",
    section: "speedControl",
    field: "speedLimitControl.offsetType",
  },
  {
    spKey: "SpeedLimitValueOffset",
    section: "speedControl",
    field: "speedLimitControl.offsetValue",
  },
  {
  ...
  { spKey: "BlindSpot", section: "laneChange", field: "bsmMonitoring" },
  {
    ...
    section: "laneChange",
    field: "blinkerPauseLateral",
  },
  {
    spKey: "BlinkerLateralReengageDelay",
    section: "laneChange",
    field: "blinkerReengageDelay",
  },
  // Navigation
...
console.log(
  `${BOLD}${RED}⚠  Official docs parameters NOT in SunnyTune  (${totalMissing} total)${RESET}`,
);
console.log(
  `${DIM}   These are configurable settings in the official sunnypilot docs we don't expose in the configurator.${RESET}`,
);
...
console.log(
  `${DIM}   These may be undocumented or SP-internal params, or have different docs IDs.${RESET}\n`,
);
for (const r of spKeysNotInDocs) {
  console.log(
    `  ${YEL}•${RESET} ${r.spKey}  ${DIM}(${r.section}.${r.field})${RESET}`,
  );
}
...
console.log(
  `${DIM}   Add FIELD_HELP entries for these to show tooltip content in the configurator.${RESET}\n`,
);
...
console.log(
  `  ${GRN}Covered by docs     :  ${coveredByDocs} / ${totalOur}${RESET}`,
);
console.log(`  ${GRN}Have tooltip help   :  ${withHelp} / ${totalOur}${RESET}`);
console.log(
  `  ${RED}Docs params we skip :  ${totalMissing}${RESET}  (see above for candidates)`,
);
console.log();

// ── Section 4: field placement advisory ───────────────────────────────────────
console.log(
  `${BOLD}── Section placement differences (our app vs official docs)${RESET}`,
);
console.log(
  `${DIM}   These fields are assigned to a different section in the official docs.${RESET}`,
);
console.log(
  `${DIM}   Our grouping is intentional but documented here for awareness.\n${RESET}`,
);

const PLACEMENT_NOTES: ReadonlyArray<{
  spKey: string;
  ourSection: string;
  docsSection: string;
  note: string;
  ...
  {
    spKey:
      "Mads / MadsMainCruiseAllowed / MadsSteeringMode / MadsUnifiedEngagementMode",
    ourSection: "commaAI",
    docsSection: "Steering — MADS",
  ...
  },
  {
    ...
    ourSection: "laneChange",
    docsSection: "Steering — Lane Change",
...
for (const n of PLACEMENT_NOTES) {
  ...
  console.log(
    `    Our section : ${GRN}${n.ourSection}${RESET}    Docs section : ${YEL}${n.docsSection}${RESET}`,
  );
