...
export const LANE_CHANGE_FEATURES: FeatureDefinition[] = [
  ...
  },
  {
    ...
    description:
      "SP integer enum controlling how the lane change is triggered. -1=Off, 0=Nudge (default), 1=Nudgeless (begins immediately), 2=0.5 s, 3=1 s, 4=2 s, 5=3 s.",
    type: "select",
    default: 0,
    options: [
      { label: "Off (auto lane change disabled)", value: -1 },
      { label: "Nudge required (default)", value: 0 },
      { label: "Nudgeless — begins immediately", value: 1 },
      { label: "0.5 s after signal", value: 2 },
      { label: "1.0 s after signal", value: 3 },
      { label: "2.0 s after signal", value: 4 },
      { label: "3.0 s after signal", value: 5 },
    ],
  ...
  },
  {
    ...
    description:
      "Delay the auto lane change when blind spot monitoring (BSM) detects a vehicle in your blind spot.",
    type: "toggle",
    default: false,
...
export const COMMA_AI_FEATURES: FeatureDefinition[] = [
  ...
  },
  {
    ...
    description:
      "Controls MADS behaviour when the brake pedal is pressed. Remain Active (0) = steering stays active through braking. Pause (1) = pauses on brake, resumes when released. Disengage (2) = fully disengages, must re-engage manually.",
    type: "select",
    default: 0,
    options: [
      { label: "Remain Active — steer through braking", value: 0 },
      { label: "Pause — pauses on brake, resumes on release", value: 1 },
      { label: "Disengage — must re-engage manually", value: 2 },
    ],
...
export const INTERFACE_FEATURES: FeatureDefinition[] = [
  ...
  },
  {
    ...
    description:
      "Display blind spot warning indicators on the HUD when vehicles are detected in adjacent lanes. Requires factory BSM hardware.",
    type: "toggle",
    default: false,
    spKey: "BlindSpot",
    since: "2024",
  ...
  },
  {
    ...
    description:
      "Always display the GPS-based true ground speed instead of the odometer speed. Useful for vehicles with inaccurate speedometers.",
    type: "toggle",
    default: false,
    spKey: "TrueVEgoUI",
    since: "2024",
  ...
  },
  {
    ...
    description:
      "Display additional metrics below the lead car chevron on the HUD. Off=hidden, Distance=gap to lead, Speed=relative speed, Time=time gap, All=all metrics.",
    type: "select",
    default: 0,
    options: [
      { label: "Off", value: 0 },
  ...
  },
  {
    ...
    description:
      "Enable Rainbow Mode on Tesla vehicles — cosmetic only, changes steering wheel colours on the HUD.",
    type: "toggle",
    default: false,
    spKey: "RainbowMode",
    since: "2023",
