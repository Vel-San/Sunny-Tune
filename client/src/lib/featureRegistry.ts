...
export const INTERFACE_FEATURES: FeatureDefinition[] = [
  ...
  },
  {
    ...
    label: "Steering Arc",
    description:
      "Show a steering arc overlay on the onroad HUD indicating the projected path based on current steering angle.",
    type: "toggle",
    default: false,
    spKey: "SteeringArc",
    since: "2024",
  ...
  },
  {
    ...
    description:
      "Display additional metrics (distance, speed delta) below the lead car chevron on the HUD.",
    type: "toggle",
    default: false,
    spKey: "ChevronInfo",
    since: "2024",
